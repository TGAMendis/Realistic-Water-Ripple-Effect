;(function() {
  ...
  function initPixi() {
    ...
    var image = new PIXI.Sprite.from("https://i.ibb.co/BnJTDw9/shutterstock-254911351-1100x600.jpg");
    image.width = window.innerWidth;
    image.height = window.innerHeight;
    app.stage.addChild(image);
    displacementSprite = new PIXI.Sprite.from("https://i.ibb.co/T8y5jLY/cloud.jpg");
